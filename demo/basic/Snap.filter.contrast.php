...
<div id="zxxBody" class="zxx_body">
    ...
    <div class="zxx_api_detail">
    	<div class="zxx_api_content">
        	...
        	<h2>Snap.filter.contrast(amount)</h2>
        	<p>返回反差滤镜的SVG标记字符串。</p>
            <h3>参数</h3>
            <ul>
            	<li><code>amount</code> 数值。范围<code>0~1</code>, 表示滤镜数量。可以理解为明暗对比反差。<code>0</code>表示无反差，也就是全灰暗，<code>1</code>表示真实反差，图片等原本色彩。</li>
            </ul>
            <h3>返回值</h3>
            <p>字符串。表示滤镜。</p>
            <h3>使用</h3>
...
var f = svg.paper.filter(Snap.filter.<mark>contrast</mark>(0.5));
...
// 反差滤镜, 50%
var f = svg.paper.filter(Snap.filter.contrast(0.5));
// 应用在图片上
image.attr({
    filter: f	
});
