...
<div id="zxxBody" class="zxx_body">
    ...
    <div class="zxx_api_detail">
    	<div class="zxx_api_content">
        	...
        	<h2>Element.prepend(el)</h2>
        	<p>当前元素内部前置给定元素。也就是<code>el</code>要塞到<code>Element</code>的里面，同时是最前面。</p>
            <h3>参数</h3>
            <ul>
            ...
            <p>元素。返回父元素。</p>
            <h3>使用</h3>
            <pre>&lt;svg id="svg1" width="120" height="100">&lt;/svg>
...
document.querySelector("#button").addEventListener("click", function() {
    ...
    this.value = "蹭饭成功";
            ...
            <p><img src="../../static/img/demo-snap-svg-26.png"><tip data-content="截图"></tip></p>
        </div>
    </div>
</div>
...
var c2 = svg2.paper.circle(70, 50, 40).attr({
    fill: "#00f"	// 蓝色
});
